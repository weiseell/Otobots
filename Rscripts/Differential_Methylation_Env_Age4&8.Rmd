...
getMethylationStats(myobj_Age8[[8]], plot=TRUE, both.strands=FALSE) #Replace [[2]] with sample of interest!
...
getCoverageStats(myobj_Age8[[8]], plot=TRUE, both.strands=FALSE) #Again, replace [[2]] with sample of interest.
...
filtered.myobj=filterByCoverage(myobj_Age8,lo.count=10,lo.perc=NULL,hi.count=NULL,hi.perc=99.9)
...
bedgraph(myDiff.tiles2.all, file.name = "Sdev12_Age8_DMR_All.bedgraph", col.name = "qvalue")
...
bedgraph(myDiff.tiles2.hypo, file.name = "Sdev12_Age8_DMR_Hypo.bedgraph", col.name = "qvalue")
```
