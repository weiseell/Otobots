...
res_comb_all <- res_comb_all %>% mutate(Age=exp(LogAge),EpiAge=exp(s.0.2833684))
...
res_comb_all_f <- res_comb_all_f %>% mutate(Age=exp(LogAge),EpiAge=exp(s.0.2833684))
...
res_comb_all_m <- res_comb_all_m %>% mutate(Age=exp(LogAge),EpiAge=exp(s.0.2833684))
